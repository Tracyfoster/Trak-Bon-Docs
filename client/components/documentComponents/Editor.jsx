    ...
    return (
      <div>
        <form onSubmit={this.onSubmit}>
          <div className="document-form-title-wrapper">
            <Textfield
          ...
          <div className="document-form-access-wrapper">
            <div
              className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label has-placeholder">
