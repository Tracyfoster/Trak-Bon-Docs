...
describe('Documents Reducer', () => {
  ...
  it('should set documents when passed SET_USER_DOCUMENTS', () => {
    ...
    // act
    const newState = documents(initialState.documents, action);
    expect(newState.userDocuments.data).toEqual(documentToLoad.documents.rows);
    expect(newState.userDocuments.totalItems).toEqual(documentToLoad.documents.count);
  });
